 ...
 */
public class tela_jfile_choose extends javax.swing.JFrame {

    /**
     * Creates new form tela_jfile_choose
     */
    public tela_jfile_choose() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int returno = fileChooser.showOpenDialog(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tela_jfile_choose.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tela_jfile_choose().setVisible(true);
            }
        });
    }
