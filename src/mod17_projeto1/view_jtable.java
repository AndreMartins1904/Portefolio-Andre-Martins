 ...
 */
public class view_jtable extends javax.swing.JFrame {

    /**
     * Creates new form view_jtable
     */
    public view_jtable() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_jtable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_jtable().setVisible(true);
            }
        });
    }
